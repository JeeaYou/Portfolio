...
def analyze_original_audio_librosa(audio_file, sample_rate=44100):
    ...
    genre = estimate_genre(tempo, energy_score)
...
def estimate_genre(bpm, energy_score):
    if bpm >= 120 and energy_score >= 70:
        return "Dance / EDM-like"
    elif bpm >= 100 and energy_score >= 60:
        return "Pop-like"
    elif bpm < 90 and energy_score < 50:
        return "Ballad / Acoustic-like"
    elif bpm >= 140 and energy_score >= 65:
        return "Rock / Electronic-like"
    else:
